// protoc-gen-connect-errors-go is a protoc plugin that generates type-safe
...
func main() {
	...
	if *showVersion {
		fmt.Fprintf(os.Stderr, "protoc-gen-connect-errors-go %s\n", version)
		os.Exit(0)
	}
...
func generateFile(gen *protogen.Plugin, file *protogen.File) {
	...
	g.P("// Code generated by protoc-gen-connect-errors-go. DO NOT EDIT.")
	g.P()
